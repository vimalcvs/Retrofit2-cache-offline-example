package www.technovimal.com.webapi;
...
import www.technovimal.com.MyApplication;
...
public class APIService {
    ...
    private static HttpLoggingInterceptor httpLoggingInterceptor() {
        HttpLoggingInterceptor httpLoggingInterceptor = new HttpLoggingInterceptor(message -> Log.d(TAG, "log: http log: " + message));
